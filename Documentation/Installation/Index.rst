...
..  tabs::
    ...
    ..  group-tab:: Composer
        ...
        ..  code-block:: bash
            ...
            composer require 'fgtclb/academic-persons-sync':'^2'
        ...
        ..  tip::
            ...
            ..  code-block:: bash
                ...
                composer require 'fgtclb/academic-persons-sync':'~2.3.1@dev'

    ..  group-tab:: Extension Manager

        #.  Switch to the module :guilabel:`Admin Tools > Extensions`.
        #.  Switch to :guilabel:`Get Extensions`.
        #.  Search for the extension key :guilabel:`academic_persons_sync`.
...
..  _TER: https://extensions.typo3.org/extension/academic_persons_sync
..  _GitHub Releases: https://github.com/fgtclb/academic-persons-sync/releases
